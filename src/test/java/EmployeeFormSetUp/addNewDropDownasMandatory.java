...
import EmployeeFormSetupPajeObjects.addDropdownasMandatoryField;
...
public class addNewDropDownasMandatory extends  LoginPageSetup{
	...
	public void fieldsblank()
	{
		try
		{
			 driver.get(prop.getProperty("url"));
				...
				addDropdownasMandatoryField adm=new addDropdownasMandatoryField(driver);
				adm.adDropDownAsMandatoryField().click();
				atm.textParameterName().sendKeys("Mydropdown Filter");
				...
				{
					if(fields.getText().equalsIgnoreCase("Mydropdown Filter"))
					{
						fields.click();
