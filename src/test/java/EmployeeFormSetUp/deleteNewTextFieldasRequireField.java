...
public class deleteNewTextFieldasRequireField extends  LoginPageSetup{
		...
		try
		{
			 driver.get(prop.getProperty("url"));
				...
				Thread.sleep(2000);
		     	...
		     	{
		     		if(textfields.get(i).getText().equalsIgnoreCase("Mydropdown Filter new*"))
		     		{
		     			driver.findElements(By.xpath("//div[@style=\'padding:0px !important;margin-bottom: 10px;display:flex;\']/img[1]")).get(i).click();
		     	...
		     	{
		     		if(textfields1.get(i).getText().equalsIgnoreCase("Mydropdown Filter new"))
		     		{
