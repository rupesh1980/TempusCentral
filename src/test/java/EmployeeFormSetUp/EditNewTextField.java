...
public class EditNewTextField extends  LoginPageSetup{
		...
		try
		{
			 driver.get(prop.getProperty("url"));
				...
				Thread.sleep(2000);
		     	...
		     	{
		     		if(textfields.get(i).getText().equalsIgnoreCase("Mysecfield"))
		     		{
		     	...
		     	Thread.sleep(2000);
		     	atm.textParameterName().sendKeys("Mysecfield new");
		     	Thread.sleep(2000);
