...
public class EditNewTextFieldasRequireField extends  LoginPageSetup{
		...
		try
		{
			 driver.get(prop.getProperty("url"));
				...
				Thread.sleep(2000);
		     	...
		     	{
		     		if(textfields.get(i).getText().equalsIgnoreCase("MyRequireTextField*"))
		     		{
		     	...
		     	Thread.sleep(2000);
		     	atm.textParameterName().sendKeys("MyRequireTextField new");
		     	Thread.sleep(2000);
