...
public class addNewFieldAsTextRequiredField extends  LoginPageSetup{
	...
	public void addNewFieldasTextRequiredField()
	{
		try
		{
			 driver.get(prop.getProperty("url"));
				...
				atm.textParameterName().sendKeys("MyRequireTextField");
				atm.clickAdd().click();
				...
				{
					if(textfields.getText().equalsIgnoreCase("MyRequireTextField"))
					{
						textfields.click();
						break;
