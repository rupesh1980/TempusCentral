...
public class EditNewDropdownasMandatory extends  LoginPageSetup{
			 ...
			 driver.get(prop.getProperty("url"));
				...
				Thread.sleep(2000);
		     	...
		     	for(int i=0;i<textfields.size();i++)
		     	{
		     		...
		     		if(textfields.get(i).getText().equalsIgnoreCase("Mydropdown Filter*"))
		     		{
		     	...
		     	Thread.sleep(2000);
		     	atm.textParameterName().sendKeys("Mydropdown Filter new");
		     	Thread.sleep(2000);
