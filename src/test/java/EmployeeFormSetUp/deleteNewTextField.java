...
public class deleteNewTextField extends  LoginPageSetup{
	...
	public void fieldsblank()
	{
		try
		{
			 driver.get(prop.getProperty("url"));
				...
				Thread.sleep(2000);
		     	List<WebElement> textfields=driver.findElements(By.xpath("//div[@style=\'width: 100% !important;\']/label"));
		     	for(int i=0;i<textfields.size();i++)
		     	{
		     		if(textfields.get(i).getText().equalsIgnoreCase("Mysecfield new"))
		     		{
		     	...
		     	{
		     		if(textfields1.get(i).getText().equalsIgnoreCase("Mysecfield new"))
		     		{
