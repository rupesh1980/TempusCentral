...
public class AdminRoleCompanyLocationAddViewEditDeletecheck extends LoginPageSetup{
    ...
    private By saverecord=By.id("btnLocationSave");
  ...
  //  private By clickAdd=By.id("btnDepartmentSave");
    ...
    private By message=By.xpath("//*[@id=\'toast-container\']/div/div");
	  ...
	  private By longitudelatitude=By.id("txtLatitude");
	//  private By deletebutton=By.xpath("//*[@id=\'deleteButton\']/span[2]");
	  private By delbutton=By.xpath("//*[@id=\'deleteButton\']/span[2]");
	  private By yesdelete=By.id("YesDeleteLocation");
	...
	public void companyLocatinEditRecord() throws InterruptedException
	{
	...
	//  amfp.clickCompanyLocation().click();
		...
		Thread.sleep(2000);
		driver.findElement(longitudelatitude).sendKeys("400");
		driver.findElement(saverecord).click();
		System.out.println("User has edited record");
	...
	{  
		...
		//wait.until(ExpectedConditions.visibilityOfElementLocated(delbutton));
    //   driver.findElement(delbutton).click();
	//	wait.until(ExpectedConditions.visibilityOfElementLocated(yesdelete));

		Thread.sleep(2000);
		driver.findElement(By.id("YesDeleteLocation")).click();
		System.out.println("User has deleted the record");
	...
	public void companyLocationAdd() throws InterruptedException
	{
		...
		if(result==true)
		{
			System.out.println("user has added the record");
