...
public class AdminRoleCompanyLocationAddViewDeleteCheck extends LoginPageSetup{
  ...
  //  private By clickAdd=By.id("btnDepartmentSave");
	...
	//  amfp.clickCompanyLocation().click();
		...
		Thread.sleep(2000);
         String editresult=driver.findElement(By.id("btnLocationSave")).getAttribute("disabled");
