...
public class FullUserAdminRoleCompanyLocationAddViewDelete extends LoginPageSetup {
	...
	public void fullUseAccessAddVewDeleteOnly() throws InterruptedException {
		CompanyDetailsFieldsBlank cd = new CompanyDetailsFieldsBlank(driver);
