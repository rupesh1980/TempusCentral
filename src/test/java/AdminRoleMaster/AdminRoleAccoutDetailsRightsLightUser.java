...
import AdminRoleMasterPajeObjects.addAeminRoleLightUser;
...
public class AdminRoleAccoutDetailsRightsLightUser extends LoginPageSetup{
   ...
   public void addFullAccesUser() throws InterruptedException
   {
	  ...
	  // List<WebElement> tablerows=table.findElements(By.tagName("td"));
	   ...
	   wait.until(ExpectedConditions.visibilityOfElementLocated(AccountDetailsView));
	   
	   //Thread.sleep(2000);
	   
	   addAeminRoleLightUser arf=new addAeminRoleLightUser(driver);
	 // driver.findElement(By.xpath("//*[@id=\'TableContent1\']/div[2]/div/div[2]/label/span")).click();
	   arf.clickAccountDetailsView().click();
		arf.clickUpdate().click();
