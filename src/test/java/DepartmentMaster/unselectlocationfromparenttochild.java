...
public class unselectlocationfromparenttochild extends LoginPageSetup {
  ...
  //  private By clickarrow=By.xpath("//li[@class=\'jstree-node jstree-closed\']/div");
	...
	public void UpdateDepartment() throws InterruptedException
	{
		...
		//	System.out.println("total numer are:" + location.size());
			...
			Thread.sleep(1000);
		//	List<WebElement> locations=driver.findElements(By.xpath("//i[@class=\'jstree-icon jstree-checkbox\']"));
		//	List<WebElement> locations=driver.findElements(By.xpath("//a[@aria-selected=\'true\']"));
			List<WebElement> locations=driver.findElements(By.xpath("//a[@aria-selected=\'true\']"));
			Thread.sleep(1000);
			...
			{
          driver.findElements(By.xpath("//i[@class=\'jstree-icon jstree-checkbox\']")).get(i).click();
			}
		  boolean message=driver.findElement(By.xpath("//*[@id=\'toast-container\']/div/div")).isDisplayed();
		  if(true)
		  {
			  System.out.println("Please unassign child department from this location and department first.");
		  }
		  else
		  {
